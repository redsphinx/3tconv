...
def generate_sequence_dots(the_class, num_frames, seed, window_side, really_big=False, big_factor=5):
...
# for i in range(10):
#     generate_sequence_dots(the_class='scale', num_frames=30, seed=0, window_side=32, really_big=True)
#     generate_sequence_dots(the_class='translate', num_frames=30, seed=0, window_side=32, really_big=True)
#     generate_sequence_dots(the_class='rotate', num_frames=30, seed=0, window_side=32, really_big=True)